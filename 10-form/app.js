...
app.set("views", "./views"); //view 템플릿 파일ㅇ르 찾을 때 사용할 디렉토리 지정
...
// get 방식은 클라이언트에서 보낸 데이터가 req.query에 저장이 됨
...
// post 방식은 클라이언트에서 보낸 데이터가 req.body에 저장이 됨
app.post("/login", (req, res) => {
    // console.log(req.body);      //{ id: 'baba', pw: '1234' }
    // res.send('post 요청 성공')
